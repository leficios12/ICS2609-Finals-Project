...
?>
<a href="librariandashboard.php" class="btn btn-sm btn-primary" style="position: fixed; top: 10px; left: 10px; z-index: 9999;">Go to Dashboard</a>
...
<form action="ViewBook.php" method="post" enctype="multipart/form-data">
    ...
    <div class="col text-center">
        <div class="row">
            ...
            <div class="col">  
                <input required type="file" name="upload_img" class="form-control mt-3" onchange="previewImage(event);">      
            </div>
        </div>
    </div>
</div>
...
if(isset($_POST['submit'])) {
    ...
    $status = $_POST['status']; 
    $img_path = "Backend/images/".$_FILES['upload_img']['name'];
    $target_file = "../../".$img_path;
    copy($_FILES['upload_img']['tmp_name'], $target_file);
